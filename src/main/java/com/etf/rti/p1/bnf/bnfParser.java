...
public class bnfParser extends AParser {
		...
		try {
			...
			((Rule_Context)_localctx).rhs = rhs();
			 printFirst(((Rule_Context)_localctx).lhs.v);
			                      ...
			                      println(";");
			                      rule.setRule(new Nonterminal(((Rule_Context)_localctx).lhs.v));
	...
	public final AlternativesContext alternatives(String conector) throws RecognitionException {
		...
		try {
			...
			((AlternativesContext)_localctx).v =  ((AlternativesContext)_localctx).a.v; rule.setNewOptionForInsert();
			setState(58);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==BAR) {
				...
				_localctx.v += conector + ((AlternativesContext)_localctx).b.v; rule.setNewOptionForInsert();
				}
				}
				setState(60);
				_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					((AlternativeContext)_localctx).element = element();
					 if (_localctx.v == null) ((AlternativeContext)_localctx).v =  ((AlternativeContext)_localctx).element.v; else _localctx.v += " " + ((AlternativeContext)_localctx).element.v;
					}
					} 
				}
				setState(68);
		...
		try {
			...
			case LETTER:
				...
				((ElementContext)_localctx).v =  "\'" + StringEscapeUtils.escapeJava((((ElementContext)_localctx).t!=null?_input.getText(((ElementContext)_localctx).t.start,((ElementContext)_localctx).t.stop):null)) + "\'";
				                rule.insertElem(new Terminal((((ElementContext)_localctx).t!=null?_input.getText(((ElementContext)_localctx).t.start,((ElementContext)_localctx).t.stop):null)));
				}
				break;
			case LT:
				...
				((ElementContext)_localctx).v =  ((ElementContext)_localctx).id.v;
				          rule.insertElem(new Nonterminal(((ElementContext)_localctx).id.v));
				}
				break;
			default:
	...
	public static class TextContext extends ParserRuleContext {
		public List<TerminalNode> TERMINAL() { return getTokens(bnfParser.TERMINAL); }
		...
		public List<TerminalNode> ID() { return getTokens(bnfParser.ID); }
